var BANNER_SELECTORS = {
    content: '.M-B-BannerSkyscraper__contentBlock',
    contentAnimate: 'M-B-BannerSkyscraper__contentBlock--animate',
    contentAnimateLast: 'M-B-BannerSkyscraper__contentBlock--animateLast',
    background: '.M-B-BannerSkyscraper__bg',
    backgroundAnimate: 'M-B-BannerSkyscraper__bg--animate',
    loop: '.M-B-BannerSkyscraper--loop'
};
