var BANNER_SELECTORS = {
    content: '.M-B-BannerWideLeaderBoard__contentBlock',
    contentAnimate: 'M-B-BannerWideLeaderBoard__contentBlock--animate',
    contentAnimateLast: 'M-B-BannerWideLeaderBoard__contentBlock--animateLast',
    background: '.M-B-BannerWideLeaderBoard__bg',
    backgroundAnimate: 'M-B-BannerWideLeaderBoard__bg--animate',
    loop: '.M-B-BannerWideLeaderBoard--loop'
};
