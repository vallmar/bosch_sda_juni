var BANNER_SELECTORS = {
    content: '.M-B-BannerHalfPage__contentBlock',
    contentAnimate: 'M-B-BannerHalfPage__contentBlock--animate',
    contentAnimateLast: 'M-B-BannerHalfPage__contentBlock--animateLast',
    background: '.M-B-BannerHalfPage__bg',
    backgroundAnimate: 'M-B-BannerHalfPage__bg--animate',
    loop: '.M-B-BannerHalfPage--loop'
};
