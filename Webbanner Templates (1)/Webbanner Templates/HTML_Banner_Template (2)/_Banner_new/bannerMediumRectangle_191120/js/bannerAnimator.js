var BANNER_SELECTORS = {
    content: '.M-B-BannerMedium__contentBlock',
    contentAnimate: 'M-B-BannerMedium__contentBlock--animate',
    contentAnimateLast: 'M-B-BannerMedium__contentBlock--animateLast',
    background: '.M-B-BannerMedium__bg',
    backgroundAnimate: 'M-B-BannerMedium__bg--animate',
    loop: '.M-B-BannerMedium--loop'
};
